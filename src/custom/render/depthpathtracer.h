/*
 * DepthPathtracer is an IPathtracer, witch represents distance from the
 * viewpoint to the objects on the scene. The further the distance, the lower
 * intensity in has.
 *
 */
...
{
    class DepthPathtracer : public core::render::IPathtracer
    {
    public:
